/**
 * 🎁 AirdropAgent v7.8 – Memory‑Optimized (Full)
 * - All features: RSS, Twitter, Discord, GitHub, on‑chain, scoring, buttons, etc.
 * - Memory‑safe loading: caps posted links, pending items, feed caches
 * - Auto‑trimming caches in cleanup() and aggressiveCleanup()
...
// ─── Memory limits ─────────────────────────────────────────────
const MAX_POSTED_LINKS = 1000;
const MAX_PENDING_ITEMS = 100;
const MAX_FEED_CACHES = 50;
const MAX_GLOBAL_POSTED_HARD_CAP = 1500;
...
class AirdropAgent extends BaseAgent {
  ...
  // ---------- Discord message scanning (bounded) ----------
